...
import pandas as pd
import heapq
from helloBERTopic.dataset import load_data
from helloBERTopic.utils import DATA_PATH, EXPORT_PATH
...
def main(data_df):
    ...
    # 取出斷詞關鍵字
    keysfile = f"{DATA_PATH}/keys_v2.txt"
    ...
    # model = SentenceTransformer("./data/paraphrase-multilingual-MiniLM-L12-v2")
    ...
    # 儲存成 html 檔案，供前端展示使用
    bar_fig.write_html("/var/www/html/bar_fig.html")
    topic_fig.write_html("/var/www/html/topic_fig.html")
    tot_fig.write_html("/var/www/html/tot_fig.html")
